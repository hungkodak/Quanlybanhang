...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">            
            <label>Product ID (containt 4 letter and Unique)</label>
            <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Enter Product ID"></asp:TextBox>  
        </div>
        <div class="form-group col-md-6">            
            <label>Product Name</label>
            <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Enter Product Name"></asp:TextBox>  
        </div>
    </div>
